...
namespace MyAgencyVault.BusinessLibrary
{
    ...
    public class Licensee
    {
        ...
        public static void SetLastLoginTime(Guid LicenseeId)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("SetLastLoginTime Exception: " + ex.Message, true);
            }
        }
    ...
    public class LicenseeDisplayData
    {
        ...
        DateTime? _TrackDateDefault;
        [DataMember]
        public DateTime? TrackDateDefault
        {
            get
            {
            ...
            set
            {
                _TrackDateDefault = value;
                if (value != null && string.IsNullOrEmpty(TrackDateDefaultString))
                {
                    TrackDateDefaultString = value.ToString();
                }
            }
        }
        string _TrackDateDefaultString;
        [DataMember]
        public string TrackDateDefaultString
        {
            get
            {
                return _TrackDateDefaultString;
            }
            set
            {
                _TrackDateDefaultString = value;
                if (TrackDateDefault == null && !string.IsNullOrEmpty(_TrackDateDefaultString))
                {
                    DateTime dt;
                    DateTime.TryParse(_TrackDateDefaultString, out dt);
                    TrackDateDefault = dt;
                }
            }
        }
