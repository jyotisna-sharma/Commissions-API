...
{
    [DataContract]
    public class FollowupIssueListObject
    {
        ...
        //[DataMember]
        //public bool? IsResolvedFromCommDashboard { get; set; }
        //[DataMember]
        ...
        //        if (value != null && string.IsNullOrEmpty(NextFollowupDateString))
        //        {
        //            NextFollowupDateString = value.ToString();
        //        }
        //    }
        //}
        //string nextfollowString;
        //[DataMember]
        //public string NextFollowupDateString
        //{
        //    get
        //    {
        //        return nextfollowString;
        //    }
        //    set
        //    {
        //        nextfollowString = value;
        //        if (NextFollowupDate == null && !string.IsNullOrEmpty(nextfollowString))
        //        {
        //            DateTime dt;
        //            DateTime.TryParse(nextfollowString, out dt);
        //            NextFollowupDate = dt;
        //        }
        //    }
        //}
        ...
        //        if (LastModifiedDate == null && !string.IsNullOrEmpty(lastModifiedString))
        //        {
        //            DateTime dt;
        ...
        //    {
        //        _fromDate = value;
        //        if (value != null && string.IsNullOrEmpty(FromDateString))
        //        {
        //            FromDateString = value.ToString();
        //        }
        //    }
        //}
        ...
        //    get
        //    {
        //        return _FromDateString;
        //    }
        //    set
        //    {
        //        _FromDateString = value;
        //        if (FromDate == null && !string.IsNullOrEmpty(_FromDateString))
        //        {
        //            DateTime dt;
        //            DateTime.TryParse(_FromDateString, out dt);
        //            FromDate = dt;
        //        }
        //    }
        //}
        ...
        //    {
        //        _toDate = value;
        //        if (value != null && string.IsNullOrEmpty(ToDateString))
        //        {
        //            ToDateString = value.ToString();
        //        }
        //    }
        //}
        ...
        //    get
        //    {
        //        return _ToDateString;
        //    }
        //    set
        //    {
        //        _ToDateString = value;
        //        if (ToDate == null && !string.IsNullOrEmpty(_ToDateString))
        //        {
        //            DateTime dt;
        //            DateTime.TryParse(_ToDateString, out dt);
        //            ToDate = dt;
        //        }
        //    }
        //}
    ...
    [DataContract]
    public class FollowupIssuePolicyListObject
    {
        [DataMember]
    ...
    [DataContract]
    public class ListRequestObjectWeb
    {
        [DataMember]
        public string Payor { get; set; }
        [DataMember]
        ...
        //[DataMember]
        //public ListParams listParams { get; set; }
    }
    ...
    public class FollowupIssue : IEditable<DisplayFollowupIssue>
    {
        ...
        /// <returns></returns>
        public static FollowupIssueDetail GetFollowupIssueDetails(Guid issueId)
        {
            FollowupIssueDetail details = new FollowupIssueDetail();
            try
            {
                ActionLogger.Logger.WriteLog("GetFollowupIssueDetails:Process begins with issueId" + issueId, true);
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("usp_GetFollowUpIssueDetails", con))
                    {
                        ...
                        while (reader.Read())
                        {
                            details.IssueId = reader.IsDBNull("IssueId") ? Guid.Empty : (Guid)reader["IssueId"];
                            details.IssueCategoryId = reader.IsDBNull("CategoryId") ? 0 : (int)reader["CategoryId"];
                            details.IssueStatusId = reader.IsDBNull("StatusId") ? 0 : (int)reader["StatusId"];
                            details.IssueResultId = reader.IsDBNull("ResultId") ? 0 : (int)reader["ResultId"];
                            details.IssueReasonId = reader.IsDBNull("ReasonId") ? 0 : (int)reader["ReasonId"];
                            details.PolicyNumber = reader.IsDBNull("PolicyNumber") ? "" : (string)reader["PolicyNumber"];
                            details.Client = reader.IsDBNull("ClientName") ? "" : (string)reader["ClientName"];
                            details.Payor = reader.IsDBNull("PayorName") ? "" : (string)reader["PayorName"];
                            details.InvoiceDate = reader.IsDBNull("InvoiceDate") ? DateTime.Now : (DateTime)reader["InvoiceDate"];
                            details.NextFollowupDate = reader.IsDBNull("NextFollowupDate") ? DateTime.Now : (DateTime)reader["NextFollowupDate"];
                        }
            ...
            {
                ActionLogger.Logger.WriteLog("GetFollowupIssueDetails:ProException occurs while processing with issueId" + issueId + " " + ex.Message, true);
                throw ex;
            }
            return details;
        }
        /// Createdby:Ankit Khandelwal
        /// CreatedOn:03-07-2020
        /// Purpose: Update follow up issue details
        /// </summary>
        /// <param name="_DisplayFollowupIssue"></param>
        /// <param name="PreviousStatusId"></param>
        /// <param name="ModifiedBy"></param>

        public static void UpdateFollowUpIssuesDetails(DisplayFollowupIssue _DisplayFollowupIssue, int previousStatusId, Guid modifiedBy)
        {
            ActionLogger.Logger.WriteLog("UpdateFollowUpIssuesDetails:Processing begins with issueId " + _DisplayFollowupIssue.IssueId, true);
            try
            {
                using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
                {
                    ...
                    if (_followUpIssueLst != null)
                    {
                        ...
                        _followUpIssueLst.ModifiedBy = modifiedBy;
            ...
            {
                ActionLogger.Logger.WriteLog("UpdateFollowUpIssuesDetails:Exception occurs while processing with issueId" + _DisplayFollowupIssue.IssueId + ex.Message, true);
                throw ex;
            }
        }
        ...
        /// <param name="policyID"></param>
        /// <returns></returns>
        public static bool IfPolicyHasIssues(Guid policyID)
        {
            ...
            using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
            {
                ...
                count = (from p in Result
                         where (p.PolicyId == policyID)
                         select p.IssueId).ToList().Count;
            }
            return count > 0;
        }
        ...
        public static List<DisplayFollowupIssue> GetIssues(Guid policyID)
        {
            using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
            {
                ...
                List<DisplayFollowupIssue> _FollowupIssue = (from p in Result
                                                             join Category in DataModel.MasterIssueCategories on p.IssueCategoryId equals Category.IssueCategoryId
                                                             join result in DataModel.MasterIssueResults on p.IssueResultId equals result.IssueResultId
                                                             join status in DataModel.MasterIssueStatus on p.IssueStatusId equals status.IssueStatusId
                                                             join Reason in DataModel.MasterIssueReasons on p.IssueReasonId equals Reason.IssueReasonId
                                                             where (p.PolicyId == policyID)
        ...
        public static List<DisplayFollowupIssue> GetFollowupIssues(Guid policyID, ListParams listParams)
        {
            List<DisplayFollowupIssue> lst = new List<DisplayFollowupIssue>();
            using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
            {
                var sortBy = listParams.sortBy;
                if (sortBy == "InvoiceDateString")
                {
                    sortBy = "InvoiceDate";
                }
                var sortType = listParams.sortType;
                var Result = DataModel.GetIssues(policyID);
                List<DisplayFollowupIssue> _FollowupIssue = (from p in Result
                                                             join Category in DataModel.MasterIssueCategories on p.IssueCategoryId equals Category.IssueCategoryId
                                                             join result in DataModel.MasterIssueResults on p.IssueResultId equals result.IssueResultId
                                                             join status in DataModel.MasterIssueStatus on p.IssueStatusId equals status.IssueStatusId
                                                             join Reason in DataModel.MasterIssueReasons on p.IssueReasonId equals Reason.IssueReasonId
                                                             where (p.PolicyId == policyID && p.IsDeleted == false)
                                                             select new DisplayFollowupIssue
                                                             {
                                                                 IssueId = (Guid?)p.IssueId ?? Guid.Empty,
                                                                 IssueStatusId = p.IssueStatusId.Value,
                                                                 ...
                                                                 IsResolvedFromCommDashboard = p.IsResolvedFromCommDashboard
                                                             }).ToList();

                //if (sortType == "desc")
                //{
                //    lst = _FollowupIssue.OrderByDescending(x => x.GetPropertyValue(sortBy)).ToList();
                //}
                //else
                //{
                //    lst = _FollowupIssue.OrderBy(x => x.GetPropertyValue(sortBy)).ToList();
                //}
                lst = _FollowupIssue.ToList();
                return lst;
            }

        }

        public static List<DisplayFollowupIssue> GetFewIssueForCommissionDashBoard(Guid PolicyId, ListParams listParams)
        {
            List<DisplayFollowupIssue> _followIssLst = new List<DisplayFollowupIssue>();
            List<DisplayFollowupIssue> _FollowupIssue = GetFollowupIssues(PolicyId, listParams);
            ...
            if (_FollowUpMiss != null && _FollowUpMiss.Count != 0)
            {
                ...
                if (AutoTerminationDate == null) return _FollowupIssue.OrderByDescending(item => item.InvoiceDate).ToList();//return all followUp issues if there is no Autotrm date in learned
            ...
            return _followIssLst.OrderByDescending(item => item.InvoiceDate).ToList();

        }

        public static List<FollowupIssuePolicyListObject> GetPolicyIssues_Web(Guid PolicyId, ListParams_Issues listParams, out int recordCount)
        {
            List<FollowupIssuePolicyListObject> _followIssLst = new List<FollowupIssuePolicyListObject>();
            SqlCommand cmd = null;
             recordCount = 0;
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(DBConnection.GetConnectionString()))
                {
                    con.Open();
                    cmd = new SqlCommand();
                    cmd.CommandText = "usp_getPolicyIssuesList_Web";
                    cmd.CommandTimeout = 0;
                    cmd.Connection = con;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@PolicyID", PolicyId);
                    //cmd.Parameters.AddWithValue("@Status", Convert.ToString(listParams.statusId));
                    cmd.Parameters.AddWithValue("@Status", listParams.statusId);
                    ...
                    cmd.Parameters.Add("@totalLength", SqlDbType.Int);
                    cmd.Parameters["@totalLength"].Direction = ParameterDirection.Output;


                    SqlDataReader reader = cmd.ExecuteReader();
                    while (reader.Read())
                    {
                        FollowupIssuePolicyListObject objIssue = new FollowupIssuePolicyListObject();
                        objIssue.InvoiceDateString = reader.IsDBNull("Invoice") ? "" : Convert.ToDateTime(reader["Invoice"]).ToString("MM/dd/yyyy");
                        objIssue.Category = Convert.ToString(reader["Category"]);
                        objIssue.Status = Convert.ToString(reader["IssueStatus"]);
                        objIssue.Reason = Convert.ToString(reader["Reason"]);
                        objIssue.Result = Convert.ToString(reader["Result"]);
                        objIssue.IssueId = Convert.ToString(reader["IssueID"]);
                        _followIssLst.Add(objIssue);
                    }
                    reader.Close();
                }
                int.TryParse(Convert.ToString(cmd.Parameters["@totalLength"].Value), out recordCount);
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteLog("GetPolicyIssues_Web ex: " + ex.Message, true);
            }
            return _followIssLst; //.OrderByDescending(item => item.InvoiceDate).ToList();
        }
        ...
        public static List<DisplayFollowupIssue> GetAllIssues(int Status, Guid? PayorID, Guid? AgencyID, bool Followup, int? intDays)
        {
            ...
            try
            {
                using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
                {
                    ...
                    //ActionLogger.Logger.WriteLog("Before followup" + DateTime.Now.ToLongTimeString(), true);
                    ...
                    //ActionLogger.Logger.WriteLog("After followup" + DateTime.Now.ToLongTimeString(), true);
            ...
            {
                ActionLogger.Logger.WriteLog(ex.StackTrace.ToString() + DateTime.Now.ToLongTimeString(), true);
            }
        ...
        public static List<FollowupIssueListObject> GetIssueListForWeb(ListRequestObjectWeb request /* int Status, Guid PayorID, Guid AgencyID, bool Followup int intDays*/, ListParams listParams, out int recordCount)
        {
            List<FollowupIssueListObject> _followIssLst = new List<FollowupIssueListObject>();
            recordCount = 0;
            try
            {
                int rowStart = (listParams.pageSize * (listParams.pageIndex)) + 1;
                ...
                using (SqlConnection con = new SqlConnection(DBConnection.GetConnectionString()))//("Data Source=localhost;Initial Catalog=CommisionDepartmentEricDB;Integrated Security=True;MultipleActiveResultSets=True"))
                {
                    ...
                    scm.CommandText = "usp_FollowupIssuesList_Web";
                    scm.CommandTimeout = 0;

                    scm.Connection = con;
                    scm.CommandType = CommandType.StoredProcedure;
                    scm.Parameters.AddWithValue("@LicenseeId", request.AgencyID);
                    scm.Parameters.AddWithValue("@PageNumber", rowStart);
                    scm.Parameters.AddWithValue("@PageSize", rowEnd);
                    scm.Parameters.AddWithValue("@sortBy", listParams.sortBy);
                    scm.Parameters.AddWithValue("@sortType", listParams.sortType);
                    scm.Parameters.AddWithValue("@Payor", request.Payor);
                    scm.Parameters.AddWithValue("@Status", request.Status);
                    scm.Parameters.AddWithValue("@SortParams", request.SortParams);
                    scm.Parameters.AddWithValue("@InvoiceStart", request.InvoiceFrom);
                    scm.Parameters.AddWithValue("@InvoiceEnd", request.InvoiceTo);
                    scm.Parameters.Add("@totalLength", SqlDbType.Int);
                    scm.Parameters["@totalLength"].Direction = ParameterDirection.Output;

                    SqlDataReader reader = scm.ExecuteReader();
                    while (reader.Read())
                    {
                        FollowupIssueListObject objIssue = new FollowupIssueListObject();
                        objIssue.IssueId = (Guid)reader["IssueID"];
                        objIssue.PolicyId = (Guid)reader["PolicyID"];
                        objIssue.PolicyNumber = Convert.ToString(reader["PolicyNUmber"]);
                        objIssue.Client = Convert.ToString(reader["Client"]);
                        objIssue.Payor = Convert.ToString(reader["Payor"]);
                        objIssue.Category = Convert.ToString(reader["Category"]);
                        objIssue.Status = Convert.ToString(reader["IssueStatus"]);
                        objIssue.Result = Convert.ToString(reader["Result"]);
                        objIssue.Reason = Convert.ToString(reader["Reason"]);
                        objIssue.InvoiceDateString = reader.IsDBNull("Invoice") ? "" : Convert.ToDateTime(reader["Invoice"]).ToString("MM/dd/yyyy");
                        objIssue.PayorID = reader.IsDBNull("PayorID") ? Guid.Empty : (Guid)(reader["PayorID"]);
                        _followIssLst.Add(objIssue);
                    }
                    reader.Close();
                    int.TryParse(Convert.ToString(scm.Parameters["@totalLength"].Value), out recordCount);
                }
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteLog("GetIssueListForWeb ex: " + ex.Message, true);
            }
            return _followIssLst;
        }
        ...
        public static List<DisplayFollowupIssue> GetFewIssueAccordingtoModeForFollowupScr(int Status, Guid? PayorID, Guid? AgencyID, bool Followup, int intDay)
        {
            ...
            //ActionLogger.Logger.WriteLog("11 " + DateTime.Now.ToLongTimeString(), true);
        ...
        public static List<IssuePolicyDetail> GetIssueDetail(Guid PolicyId, Guid FollowUpIssueId)
        {
            ...
            using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
            {
                //ActionLogger.Logger.WriteLog("BEFORE GetIssueDetail _PMC" + DateTime.Now.ToLongTimeString(), true);
                var vPaymentPMC = 0.0;
                try
                {
                ...
                {
                    vPaymentPMC = 0;
                    // ActionLogger.Logger.WriteLog(ex.ToString() + " BEFORE GetIssueDetail _PMC" + DateTime.Now.ToLongTimeString(), true);
                }
        ...
        public static void SaveNotesFromWeb(Guid IssueID, Guid PayorID, Guid AgencyID, string IssueNotes, string PayorNotes, string AgencyPayorNotes)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(DBConnection.GetConnectionString()))
                {
                    using (SqlCommand cmd = new SqlCommand("usp_SaveFollowupNotes", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@IssueId", IssueID);
                        cmd.Parameters.AddWithValue("@PayorID", PayorID);
                        cmd.Parameters.AddWithValue("@LicenseeID", AgencyID);
                        cmd.Parameters.AddWithValue("@IssueNotes", IssueNotes);
                        cmd.Parameters.AddWithValue("@AgencyPayorNotes", AgencyPayorNotes);
                        cmd.Parameters.AddWithValue("@PayorNotes", PayorNotes);
                        con.Open();
                        cmd.ExecuteNonQuery();
                    }
                    con.Close();
            ...
            {
                ActionLogger.Logger.WriteLog("SaveNotesFromWeb ex: " + ex.Message, true);
                throw ex;
            }
        }
        ...
        public static void AddUpdate(DisplayFollowupIssue _FollowupIssue)
        {
            try
            {
                ActionLogger.Logger.WriteLog("AddUpdate processing begins: " + _FollowupIssue.IssueId, true);
                using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
                {
                    DLinq.FollowupIssue _followUpIssueLst = (from c in DataModel.FollowupIssues
                    ...
                    if (_followUpIssueLst == null)
                    {
                        ActionLogger.Logger.WriteLog("AddUpdate processing!Follow up issue found IssueId: " + _FollowupIssue.IssueId, true);
                    ...
                    {
                        ActionLogger.Logger.WriteLog("AddUpdate processing!Follow up issue update request  IssueId: " + _FollowupIssue.IssueId, true);
            ...
            {
                ActionLogger.Logger.WriteLog("AddUpdate:Exception occurs while processing  with  IssueId: " + _FollowupIssue.IssueId + "Exception:" + ex.Message, true);
                ActionLogger.Logger.WriteLog("AddUpdate:Exception occurs while processing  with inner Exception and  IssueId: " + _FollowupIssue.IssueId + "Exception:" + ex.InnerException, true);
                throw ex;
            }
        }
        ...
        /// purpose:Update and Add a Follow up issue.
        /// </summary>
        /// <param name="_FollowupIssue"></param>
        public static bool AddUpdateFollowUpIssues(DisplayFollowupIssue _FollowupIssue)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(adoConnStr))
                {
                    using (SqlCommand cmd = new SqlCommand("usp_AddupdateFollowUpIssues", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@IssueId", _FollowupIssue.IssueId);
                        cmd.Parameters.AddWithValue("@IsResolvedFromCommDashboard", _FollowupIssue.IsResolvedFromCommDashboard);
                        cmd.Parameters.AddWithValue("@IssueStatusId", _FollowupIssue.IssueStatusId);
                        cmd.Parameters.AddWithValue("@IssueResultId", _FollowupIssue.IssueResultId);
                        cmd.Parameters.AddWithValue("@LastModifiedDate", _FollowupIssue.LastModifiedDate);
                        cmd.Parameters.AddWithValue("@ModifiedBy", _FollowupIssue.ModifiedBy);
                        con.Open();
        ...
        public static void DeletePolicyPayment_And_FollowUpbyPolicyPaymentEntryId(Guid PolicyPaymentEntryId, PostEntryProcess _ActualPostEntryStatus)
        {
            try
            {
                ...
                using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
                {
                    ...
                    Guid? FollowUpVarIssueId = PolicyPaymentEntryrecord.FollowUpVarIssueId;
                    ...
                    //delete issue in case only this payment entry asociated to it.
            ...
            {
                ActionLogger.Logger.WriteLog("DeletePolicyPayment_And_FollowUpbyPolicyPaymentEntryId :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("DeletePolicyPayment_And_FollowUpbyPolicyPaymentEntryId :" + ex.InnerException.ToString(), true);
            }
    ...
    [DataContract]
    public class FollowupIssueDetail
    {
        #region "Datamembers aka - public properties"
        [DataMember]
        public Guid IssueId { get; set; }
