...
namespace MyAgencyVault.BusinessLibrary
{
    ...
    public class PayorToolField
    {
        ...
        /// UsedFor:Update Duplicate payopr details
        /// </summary>
        ...
        {
            ActionLogger.Logger.WriteLog("UpdateDuplicatePayor:processing begins with payorToolId" + PayorToolID, true);
            try
            {
                using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
                {
            ...
            {
                ActionLogger.Logger.WriteLog("UpdateDuplicatePayor:Exception occurs while processing with payorToolId" + PayorToolID +ex.Message, true);
                throw ex;
            }
        }
