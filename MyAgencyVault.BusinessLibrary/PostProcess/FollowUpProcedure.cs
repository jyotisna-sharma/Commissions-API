    ...
    public class FollowUpUtill
    {
        ...
        public static void FollowUpProcedure(FollowUpRunModules _FollowUpRunModules, DEU _DEU, Guid PolicyId, bool IsTrackPayment, bool IsEntryByCommissionDashboard, UserRole _UserRole, bool? PolicyModeChange)
        {
            ...
            try
            {
                if (IsTrackPayment)
                {
                    ...
                    else if (_FollowUpRunModules == FollowUpRunModules.PolicyDetailChange)
                    {
                        ...
                        try
                        {
                            //ActionLogger.Logger.WriteLog("FolloWpUp Started", true);
                            //ActionLogger.Logger.WriteLog(System.DateTime.Now.ToString(), true);
                            Policy.UpdateLastFollowupRunsWithTodayDate(PolicyId);
                            bool isPaymenyExist = false;
                            bool ReturnFlag = false;
                            ...
                            //ActionLogger.Logger.WriteLog("before calculated mode", true);
                            //FollowUpDate _FollowUpDate = CalculateFollowUpDateRange(_PaymentMode, policy, isPaymenyExist);
                            //ActionLogger.Logger.WriteLog("After calculated mode", true);
                            ...
                            //ActionLogger.Logger.WriteLog("FolloWpUp End", true);
                            //ActionLogger.Logger.WriteLog(System.DateTime.Now.ToString(), true);
                        }
                        catch (Exception ex)
                        {
            ...
            catch (Exception ex)
            {
                ...
                //ActionLogger.Logger.WriteLog(" issue while running follow up. FolloWpUp Failed", true);
                ActionLogger.Logger.WriteLog(ex.StackTrace.ToString(), true);
        ...
        private static void ClearPolicySmartAutoTermDate(Guid PolicyId, DEU deu)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("ClearPolicySmartAutoTermDate ex.message" + ex.Message.ToString(), true);
                ActionLogger.Logger.WriteLog("ClearPolicySmartAutoTermDate ex.StackTrace" + ex.StackTrace.ToString(), true);
            }
        ...
        public static void RegisterIssueAgainstMissingPayment(PolicyDetailsData _Policy, FollowUpIssueCategory _FollowUpIssueCategory, DateTime? Fromdate, DateTime? Todate)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("RegisterIssueAgainstMissingPayment :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("RegisterIssueAgainstMissingPayment :" + ex.InnerException.ToString(), true);
            }
        ...
        public static void UpdateTheAutoTermDateOfLearned(Guid PolicyId, DateTime? CalTermDate)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("UpdateTheAutoTermDateOfLearned :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("UpdateTheAutoTermDateOfLearned :" + ex.InnerException.ToString(), true);
            }
        ...
        public static void AutoPolicyTerminateProcess(PaymentMode _paymentmode, DateTime? MissingPaymentMonth, Guid PolicyId, int? NoOfMissingMonth, DateTime? PaymentRecivedInvoiceDateOneTime)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("AutoPolicyTerminateProcess :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("AutoPolicyTerminateProcess :" + ex.InnerException.ToString(), true);
            }
        ...
        public static void RegisterIssueAgainstScheduleVariance(PolicyPaymentEntriesPost PolicyPaymentEntriesPost)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("RegisterIssueAgainstScheduleVariance :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("RegisterIssueAgainstScheduleVariance :" + ex.InnerException.ToString(), true);
            }
        ...
        private static DateTime? ToMOnthlyDate(PolicyDetailsData _Policy, DateTime? FromDate)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("ToMOnthlyDate :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("ToMOnthlyDate :" + ex.InnerException.ToString(), true);
            }
        ...
        private static DateTime? ToOneTime(Guid PolicyId)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("ToOneTime :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("ToOneTime :" + ex.InnerException.ToString(), true);
            }
        ...
        public static void OpenMissisngIssueIfAny(DateTime? invoicedate, Guid PolicyId)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("OpenMissisngIssueIfAny :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("OpenMissisngIssueIfAny :" + ex.InnerException.ToString(), true);
            }
