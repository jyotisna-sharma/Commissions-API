...
{
    [DataContract]
    public class PostProcessWebStatus
    {
        ...
        //[DataMember]
        //public bool IsPostComplete { get; set; }
        [DataMember]
        public string ErrorMessage { get; set; }
        [DataMember]
        public int StatementNumber { get; set; }
        [DataMember]
        public string StatementStatusName { get; set; }
        [DataMember]
    ...
    public class PostUtill
    {
        ...
        public static PostProcessReturnStatus PostStart(PostEntryProcess _PostEntryProcess, Guid DeuEntryId, Guid RepostNewDeuEntryId, Guid UserId, UserRole _UserRole, PostEntryProcess _ActualPostEntryStatus, string strUnlinkClient, string Operation, bool isInvoiceEdited = false, bool isUnlinkCall = false)
        {
            ...
            try
            {
                ...
                {
                    ActionLogger.Logger.WriteLog("PostStart:process begins for firstPost " + _PostEntryProcess + ", DeuEntryId " + DeuEntryId, true);
                    DEU objDEU = new DEU();
                    ...
                    // }
                    decimal? totalenteredAmount; int? statusID; int? batchStatusID;
                    if (UserId != Guid.Empty)
                    {
                        int error;
                        DEU objdeu = new DEU(); string completeper;
                        _PostProcessReturnStatus.BatchStatementData = objdeu.UpdateBatchStatementDataOnSuccessfullDeuPost(DeuEntryId, UserId, out totalenteredAmount, out statusID, out batchStatusID, out completeper, out error);
                    }
                    ...
                    try
                    {
                        if (deuFields != null)
                        {
                            ...
                            totalenteredAmount = DEU.UpdateTotalAmountAndEntry(deuFields.StatementId, deuFields.DeuEntryId);
                        }
                    }
                    catch (Exception e)
                    {
                        ActionLogger.Logger.WriteLog("POstUtil exception: " + e.Message, true);
                    }
                ...
                else if (_PostEntryProcess == PostEntryProcess.RePost)
                {
                    ...
                    {
                        ActionLogger.Logger.WriteLog("POstUtil.PostStart :RepostNewDeuEntryId found, deleting and adding : ", true);
                    ...
                    if (DEU.GetDeuEntryidWise(_PostProcessReturnStatus.DeuEntryId).IsEntrybyCommissiondashBoard)
                    {
                        ...
                        try
                        {
                            if (deuFields != null)
                            {
                                ...
                                decimal? totalenteredAmount = DEU.UpdateTotalAmountAndEntry(deuFields.StatementId, deuFields.DeuEntryId);
                            }

                        }
                        catch (Exception e)
                        {
                            ActionLogger.Logger.WriteLog("error updating amount: " + e.Message, true);
                        }
                    }
                ...
                {
                    ActionLogger.Logger.WriteLog("POstUtil delete starts" + DeuEntryId, true);
                    bool flag = false;
                    ...
                    //    ActionLogger.Logger.WriteLog("POstUtil delete starts - dfeufields filled", true);
                    if (flag == true && !isInvoiceEdited) //acme added check to enable editing for paid entries too
                    {
                        //ActionLogger.Logger.WriteLog("POstUtil delete 111", true);
                        _PostProcessReturnStatus.IsComplete = false;
                    ...
                    else
                    {
                        try
                        {
                            ...
                            else if (ppolicy.PolicyStatusId == (int)_PolicyStatus.Pending && !isUnlinkCall)
                            {
                                try
                                {
        ...
        public static string GetStmtStatusString(int ID)
        {
        ...
        public static void PostStart_DEU(PostEntryProcess _PostEntryProcess, Guid DeuEntryId, Guid RepostNewDeuEntryId, Guid UserId, UserRole _UserRole, PostEntryProcess _ActualPostEntryStatus,/* string strUnlinkClient, string Operation, */ref PostProcessWebStatus postProcessWebStatus, bool isInvoiceEdited = false, bool isUnlinkCall = false)
        {
            ActionLogger.Logger.WriteLog("POstUtil.PostStart :_PostEntryProcess: " + _PostEntryProcess + ", DeuEntryId " + DeuEntryId, true);
            //bool isException = false;
            // PostProcessReturnStatus _PostProcessReturnStatus = new PostProcessReturnStatus() { DeuEntryId = DeuEntryId, IsComplete = false, ErrorMessage = null, PostEntryStatus = _PostEntryProcess, IsClientDeleted = false };
            ...
            try
            {
                ...
                if (_PostEntryProcess == PostEntryProcess.FirstPost)
                {
                    ...
                    BasicInformationForProcess _BasicInformationForProcess = PostUtill.GetPolicyToProcess(deuFields, string.Empty /* strUnlinkClient*/);
                    if (_BasicInformationForProcess == null)
                    {
                        // return; // _PostProcessReturnStatus;
                        ActionLogger.Logger.WriteLog("Policy found null, throwing ex", true);
                        UpdatePolicyIsProcessingFlag(DeuEntryId, false);
                        throw new Exception("Policy not found for this payment.");
                    }
                    PolicyDetailsData policytoDeu = GetPolicy(_BasicInformationForProcess.PolicyId);
                    deuFields.DeuData.PolicyId = _BasicInformationForProcess.PolicyId;
                    deuFields.DeuData.PostStatusID = (int)_BasicInformationForProcess.PostStatus;
                    ...
                    //Set this to false 
                    deuFields.DeuData.IsProcessing = false;

                    objDEU.AddupdateDeuEntry(deuFields.DeuData);
                    ActionLogger.Logger.WriteLog("PostUtil isProcessing set false" + DeuEntryId, true);
                    ...
                    int? stmtID = 0;
                    int? batchStatus = 0; string completePer = ""; decimal? totalEnteredAmount; int error = 0;
                    _PostProcessReturnStatus.BatchStatementData = objDEU.UpdateBatchStatementDataOnSuccessfullDeuPost(DeuEntryId, UserId, out totalEnteredAmount, out stmtID, out batchStatus, out completePer, out error);
                    postProcessWebStatus.EnteredAmount = totalEnteredAmount == null ? 0.ToString("C") : Convert.ToDecimal(totalEnteredAmount).ToString("N", new CultureInfo("en-US")); ;
                    postProcessWebStatus.ErrorCount = error;
                    int statementID = (stmtID == null) ? 0 : (int)stmtID;
                    postProcessWebStatus.StatementStatusID = (statementID);
                    postProcessWebStatus.StatementStatusName = GetStmtStatusString(statementID);
                    postProcessWebStatus.BatchStatusName = Batch.GetBatchStatusString(batchStatus);
                    postProcessWebStatus.CompletePercent = completePer;
                    postProcessWebStatus.PayorId = (Guid)deuFields.PayorId;
                    postProcessWebStatus.TemplateId = deuFields.TemplateID == null ? Guid.Empty : (Guid)deuFields.TemplateID;
                }
                else if (_PostEntryProcess == PostEntryProcess.RePost)
                {
                    if (RepostNewDeuEntryId != null && RepostNewDeuEntryId != Guid.Empty)
                    {
                        ActionLogger.Logger.WriteLog("POstUtil.PostStart :RepostNewDeuEntryId found, deleting and adding : ", true);
                        PostStart_DEU(PostEntryProcess.Delete, DeuEntryId, RepostNewDeuEntryId, UserId, _UserRole, _ActualPostEntryStatus, ref postProcessWebStatus, isInvoiceEdited);
                        PostStart_DEU(PostEntryProcess.FirstPost, RepostNewDeuEntryId, Guid.Empty, UserId, _UserRole, _ActualPostEntryStatus, ref postProcessWebStatus, isInvoiceEdited);
                ...
                else if (_PostEntryProcess == PostEntryProcess.Delete)
                {
                    ...
                    Guid paymentPolicyID = Guid.Empty;
                    Guid stmtID = Guid.Empty;
                    bool isPaymentInPaymentEntries = PolicyPaymentEntriesPost.IfPaymentExistsInPaymentEntries(DeuEntryId, out paymentEntryID, out paymentPolicyID, out stmtID);


                    //Check if entry delete attempted for  closed stmt 
                    if (Statement.IsStatementClosed(stmtID))
                    {
                        ActionLogger.Logger.WriteLog("Stmt found closed, throwing ex", true);
                        throw new Exception("Payment entry cannot be deleted from closed statement");
                    }


                    bool flag = PolicyOutgoingDistribution.CheckIsEntryMarkPaid(paymentEntryID); // (PolicySelectedIncomingPaymenttemp.PaymentEntryID);
                    ...
                    if (flag == true && !isInvoiceEdited) //acme added check to enable editing for paid entries too
                    {
                        ...
                        // _PostProcessReturnStatus.IsComplete = false;
                        //_PostProcessReturnStatus.ErrorMessage = "Paid/Semi Paid Entry";
                        // return totalEnteredAmount; // _PostProcessReturnStatus;
                        postProcessWebStatus.IsSuccess = false;
                        ActionLogger.Logger.WriteLog("Paid/Semi Paid Entry, throwing ex", true);
                        throw new Exception("Entry cannot be deleted as it is paid/semi paid.");
                    }
                    ...
                    if (!isPaymentInPaymentEntries)
                    {
                        ActionLogger.Logger.WriteLog("Post enrty was unsuccessfull then need to delete DEUEntryID only" + DeuEntryId, true);


                        ModifiyableBatchStatementData BatchStatementData = DEU.DeleteDeuEntry(DeuEntryId);
                        //  _PostProcessReturnStatus.IsComplete = true;
                        //  _PostProcessReturnStatus.ErrorMessage = "DEU Entry Deleted";
                        ActionLogger.Logger.WriteLog("After post enrty was unsuccessfull then need to delete ", true);
                        if (BatchStatementData != null)
                        {
                            decimal? totalEnteredAmount = BatchStatementData.StatementData.EnteredAmount;
                            postProcessWebStatus.StatementStatusID = BatchStatementData.StatementData.StatusId;
                            postProcessWebStatus.StatementStatusName = GetStmtStatusString(BatchStatementData.StatementData.StatusId);
                            postProcessWebStatus.BatchStatusID = (int)BatchStatementData.BatchData.EntryStatus;
                            postProcessWebStatus.BatchStatusName = Batch.GetBatchStatusString(postProcessWebStatus.BatchStatusID);
                            postProcessWebStatus.EnteredAmount = totalEnteredAmount == null ? 0.ToString("C") : Convert.ToDecimal(totalEnteredAmount).ToString("N", new CultureInfo("en-US")); ;
                            postProcessWebStatus.PayorId = (Guid)BatchStatementData.StatementData.PayorId;
                            postProcessWebStatus.TemplateId = BatchStatementData.StatementData.TemplateId ?? Guid.Empty;
                        }

                        DEU objDEU = new DEU();
                        objDEU.DeleteDeuEntryByID(DeuEntryId);
                        //return  _PostProcessReturnStatus;
                        ActionLogger.Logger.WriteLog("DEU Entry Deleted: " + DeuEntryId, true);
                        //throw new Exception("DEU Entry Deleted.");
                        return;
                    }



                    int entries = 0; int stmtStatus = 0; int batchStatus = 0; string completePer;
                    PolicyPaymentEntriesPost.DeletePaymentEntry(paymentEntryID, ref postProcessWebStatus /* out entries, out totalEnteredAmount, out stmtStatus, out batchStatus, out completePer*/);
                    postProcessWebStatus.StatementStatusName = GetStmtStatusString(postProcessWebStatus.StatementStatusID);

                    postProcessWebStatus.BatchStatusName = Batch.GetBatchStatusString(postProcessWebStatus.BatchStatusID);

                    DEU _LatestDEUrecord = DEU.GetLatestInvoiceForDEU(paymentPolicyID);
                    if (_LatestDEUrecord != null)
                    {
                        Guid PolicyId = DEULearnedPost.AddDataDeuToLearnedPost(_LatestDEUrecord);
                        LearnedToPolicyPost.AddUpdateLearnedToPolicy(PolicyId);
                    ...
                    else
                    {
                        ...
                        {
                            //  PolicyDetailsData ppolicy = GetPolicy(PolicySelectedIncomingPaymenttemp.PolicyID);
                            PolicyDetailsData ppolicy = GetPolicy(paymentPolicyID);
                            //if (ppolicy == null)
                            //{
                            //    _PostProcessReturnStatus.IsClientDeleted = true;
                            //}
                            //else 
                            if (ppolicy.PolicyStatusId == (int)_PolicyStatus.Pending && !isUnlinkCall)
                            {
                                try
                                {
                                    Policy.DeletePolicyCascadeFromDBById(ppolicy.PolicyId);
        ...
        static void UpdatePolicyIsProcessingFlag(Guid deuEntryID, bool flag)
        {
            ActionLogger.Logger.WriteLog(DateTime.Now.ToString() + " UpdatePolicyIsProcessingFlag for deuEntry: " + deuEntryID, true);
            int intFlag = flag ? 1 : 0;
            try
            {
                using (SqlConnection con = new SqlConnection(DBConnection.GetConnectionString()))
                {
                    using (SqlCommand cmd = new SqlCommand("Update EntriesByDEU Set IsProcessing = " + intFlag + " where deuEntryID = '" + deuEntryID + "'", con))
                    {
                        con.Open();
                        cmd.ExecuteNonQuery();
                    }
                    ActionLogger.Logger.WriteLog(DateTime.Now.ToString() + " UpdatePolicyIsProcessingFlag success: ", true);
                }
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteLog("UpdatePolicyIsProcessingFlag exception: " + ex.Message, true);
            }
        }
        public static void RemoveClient(Guid ClientId, Guid LicenseeId)
        {
            ActionLogger.Logger.WriteLog("RemoveClient request: ClientID - " + ClientId + ", LicenseeID: " + LicenseeId, true);
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(DBConnection.GetConnectionString()))
                {
                    using (SqlCommand cmd = new SqlCommand("usp_RemoveClientAfterLink", con))
                    {
                    ...
                    ActionLogger.Logger.WriteLog(DateTime.Now.ToString() + " RemoveClient success: ", true);
                }
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteLog("RemoveClient exception: " + ex.Message, true);
            }
        }


        public static void RemoveClient_old(Guid ClientId, Guid LicenseeId)
        {
            if (ClientId == Guid.Empty || LicenseeId == Guid.Empty) return;
        ...
        public static DEUFields FillDEUFields(Guid DeuEntryId)
        {
            ...
            try
            {
                ...
                {
                    deufields.BatchId = Statement.GetbatchID(deufields.StatementId);   // Statement.GetStatement(deufields.StatementId).BatchId;
                }

                if (deufields.BatchId != Guid.Empty)
                {
                    Batch objBatch = new Batch();
                    deufields.LicenseeId = objBatch.GetBatchLicensee(deufields.BatchId);    // objBatch.GetBatchViaBatchId(deufields.BatchId).LicenseeId;
                }
        ...
        public static List<DeuSearchedPolicy> GetPoliciesFromUniqueIdentifier(List<UniqueIdenitfier> _UniqueIndenties, Guid licenseId, Guid payorId)
        {
            ...
            try
            {
                if (_UniqueIndenties != null && _UniqueIndenties.Count > 0)
                {
                    Dictionary<string, object> parameters = new Dictionary<string, object>();
                    ...
                    _PolicyLst = Policy.GetPoliciesOnUniqueIdentity(parameters, licenseId);

                    /*  _policy = Policy.GetPolicyData(parameters, expressionParameters);
                      //ActionLogger.Logger.WriteLog("policy found : " + _policy
                    ...
                    if (isPrdType)
                    {
                        ...
                        _PolicyLst = _PolicyLst.Where(s => (!string.IsNullOrEmpty(s.ProductType) && s.ProductType.ToLower() == strProductType.ToLower())).ToList();
                    }
                }
            }
            catch (Exception ex)
        ...
        {
            ActionLogger.Logger.WriteLog("GetPolicyToProcess deuFields: " + deuFields.ToStringDump(), true);
            ...
            try
            {
                ...
                else if (SearchedPolicyCnt > 1)
                {
                    ...
                    {
                        //Acme commented - Jan 09, 2019
                        // As advised by kevin, when more than 1 searched policies, then link to pending policy only.
        ...
        public static PostProcessReturnStatus ProcessSearchedPoilcy(DEUFields deuFields, BasicInformationForProcess _BasicInformationForProcess, PostProcessReturnStatus _PostProcessReturnStatus)
        {
            ...
            try
            {
                ...
                if (_BasicInformationForProcess != null)
                {
                    if (deuFields != null)
                    {
                        ...
                        ////Acmem commented the following, as not required 
                        ///
                        ...
                        Guid PolicyIdDeuToLrn = DEULearnedPost.AddDataDeuToLearnedPost(deuFields.DeuData);
                        ...
                        if (deuFields.DeuData != null)
                        {
                            if (deuFields.DeuData.IsEntrybyCommissiondashBoard != null)
                            {
                                ...
                                //if (deuFields.DeuData.IsEntrybyCommissiondashBoard)   Commented by Acme - after Kevin;s response that same behavior for both DEU and comm dasboard.
                                //{
            ...
            catch (Exception ex)
            {
                ...
                ActionLogger.Logger.WriteLog("*************************", true);
                SendmailIfExceptionInDeuEntryPosting(PaymentEntryID, deuFields);
                _PostProcessReturnStatus.IsComplete = false;
            }
        ...
        {
            ActionLogger.Logger.WriteLog("GetTier2Amount begins, totalpayment: " + totalPayment + ", iscustomschedule: " + isCustomSchedule, true);
            ...
            try
            {
                ...
                if (tier1List != null && tier1List.Count > 0)
                {
                    foreach (OutGoingPayment tier1 in tier1List)
                    {
                        if (isCustomSchedule)
                        {
                            ActionLogger.Logger.WriteLog("isCustomSchedule true ", true);
                            tier1Payment += Convert.ToDouble(totalPayment) * tier1.SplitPercent / 100;
                            ActionLogger.Logger.WriteLog("tier1Payment: " + tier1Payment, true);
                        }
                        else
                        {
                            ActionLogger.Logger.WriteLog("isCustomSchedule false ", true);
                    ...
                    ActionLogger.Logger.WriteLog("GetTier2Amount is " + tier2Payment, true);
                }
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteLog(DateTime.Now.ToString() + " GetTier2Amount exception: " + ex.Message, true);
            }
            return tier2Payment;
        }
        ...
        {
            ActionLogger.Logger.WriteLog("GetTier2AmountPerHead begins, totalpayment: " + totalPayment + ", iscustomschedule: " + isCustomSchedule, true);
            double? tier2Payment = 0;
            try
            {
                double? tier1Payment = 0;
                ...
                if (tier1List != null && tier1List.Count > 0)
                {
                    ...
                    tier2Payment = totalPayment - tier1Payment;
                    ActionLogger.Logger.WriteLog("GetTier2AmountPerHead is " + tier2Payment, true);
                }
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteLog(DateTime.Now.ToString() + " GetTier2AmountPerHead exception: " + ex.Message, true);
            }
            return tier2Payment;
        }
        ...
        {
            ActionLogger.Logger.WriteLog("Policy custom schedule checking: ", true);
            ...
            if (_PolicyPaymentEntriesPost == null)
            {
                ActionLogger.Logger.WriteLog("PolicypaymententriesPost is null,PaymentEntryID: " + PaymentEntryID + " returning :", true);
                return;
            }
            ...
            ActionLogger.Logger.WriteLog("EntryInPolicyOutGoingPaymentWithCustomSchedule :_outgoingSchedule ", true);
            ...
            try
            {
                ...
                ActionLogger.Logger.WriteLog("IsTiered : " + p.IsTieredSchedule, true);

                int incomingScheduleTypeId = getIncomingScheduleTypeId(PolicyId);

                //_outgoingSchedule = (List<OutGoingPayment>)_outgoingSchedule.OrderByDescending(x => x.TierNumber);
                ...
                {
                    ActionLogger.Logger.WriteLog("_outgoingSchedule not found, checking if invoice before eff date   ", true);
                    ...
                    ActionLogger.Logger.WriteLog("received date is " + dateToCheck + ", compareDate: " + p.OriginalEffectiveDate, true);
                    ...
                    if (dateToCheck != null)
                    {
                        ...
                        if (dateToCheck < p.OriginalEffectiveDate) // no need to add <= here, as if found equal, schedule will be applied 
                        {
                            ...
                            ActionLogger.Logger.WriteLog("isInvoiceBeforeEffDate is true or false, checking if invoice before eff date   ", true);
                        }
                    }
                    ActionLogger.Logger.WriteLog("isInvoiceBeforeEffDate is " + isInvoiceBeforeEffDate, true);
                    if ((IsPaymentToHO && _outgoingSchedule.Count == 0) || isInvoiceBeforeEffDate)
                    {
                        ActionLogger.Logger.WriteLog("(IsPaymentToHO && _outgoingSchedule.Count == 0) or isInvoiceBeforeEffDate) " + isInvoiceBeforeEffDate, true);
                ...
                {
                    ActionLogger.Logger.WriteLog("_outgoingSchedule isfound,_outgoingSchedule:" + _outgoingSchedule.ToStringDump(), true);
                    ...
                    if (_outgoingSchedule.FirstOrDefault().ScheduleTypeId == (int)MasterBasicOutgoinSchedule.PercentageOfCommission)
                    {
                        ...
                        ActionLogger.Logger.WriteLog("%of comm: " + totalPayment, true);
                    ...
                    else
                    {
                        ...
                        ActionLogger.Logger.WriteLog("%of premium: " + Premium, true);
                    ...
                    PolicyOutgoingDistribution _PolicyOutgoingDistribution = new PolicyOutgoingDistribution();//new2
                    ...
                    if (_outgoingSchedule.FirstOrDefault().ScheduleTypeId == (int)MasterBasicOutgoinSchedule.PercentageOfCommission)
                    {
                        SendmailIfOutgoingMismatch(PaymentEntryID, PolicyId, IsPaymentToHO, InvoiceDate, LicenseeId);
                    }                    //}
                    ...
                    /* if (_outgoingSchedule.FirstOrDefault().ScheduleTypeId == (int)MasterBasicOutgoinSchedule.PercentageOfCommission)
                     {
                         totalPayment = Convert.ToDouble(_PolicyPaymentEntriesPost.TotalPayment);
                         tier2Payment = (p.IsTieredSchedule == true) ? GetTier2Amount(totalPayment, _outgoingSchedule, FirstYrRenewalYr.None) : 0;
                     }
                     else
                     {
                         totalPayment = Convert.ToDouble(Premium);
                     ...
                     foreach (OutGoingPayment _OutGoingPayment in _outgoingSchedule)
                     {
                         ...
                         //set total amount as incoming or tier 2 amount as per the tiered schedule. 
                         double totalAmount = (p.IsTieredSchedule == true && _OutGoingPayment.TierNumber == 2) ? Convert.ToDouble(tier2Payment) : totalPayment;
                         _PolicyOutgoingDistribution.PaidAmount = totalAmount * Convert.ToDouble(_OutGoingPayment.SplitPercent) / 100;
                ...
                ActionLogger.Logger.WriteLog("_outgoingSchedule isfound,_outgoingSchedule:" + _outgoingSchedule.ToList(), true);
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteLog("_outgoingSchedule process failure,_outgoingSchedule:" + ex.Message, true);
            }
        }

        /// <summary>
        /// Created By Jyotisna on Aug 11, 2020
        /// Purpose: to separte mail sending logic as to be called from multiple places 
        /// </summary>
        /// <param name="PaymentEntryID"></param>
        /// <param name="PolicyId"></param>
        /// <param name="IsPaymentToHO"></param>
        /// <param name="InvoiceDate"></param>
        /// <param name="LicenseeId"></param>
        static void SendmailIfOutgoingMismatch(Guid PaymentEntryID, Guid PolicyId, bool IsPaymentToHO, DateTime? InvoiceDate, Guid LicenseeId)
        {
            try
            {
                if (!CheckIsIncomingPaymentEqualsOutgoing(PaymentEntryID))
                {
                    string to = System.Configuration.ConfigurationSettings.AppSettings["DevErrorEmail"];
                    ...
                    MailServerDetail.sendMailtodev(to, "Commissions Alert: Outgoing payments mismatch from web app", body);
                }
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteLog("SendmailIfOutgoingMismatch -  exception sending mail :" + ex.Message, true);
            }
        }

        /// <summary>
        /// Created By Sahil on Jan 01, 2021
        /// Purpose: To send mail if exception occurs in deu while posting an entry
        /// </summary>
        /// <param name="PaymentEntryID"></param>
        /// <param name="deuFields"></param>
        static void SendmailIfExceptionInDeuEntryPosting(Guid PaymentEntryID, DEUFields deuFields)
        {
            try
            {
                string to = System.Configuration.ConfigurationSettings.AppSettings["DevErrorEmail"];
                string body = "An issue has occurred while posting an entry with following details : ";

                if (deuFields != null)
                {
                    ActionLogger.Logger.WriteLog("deuFields is not null", true);

                    body += "\nPolicyID: " + deuFields.DeuData.PolicyId;
                    //body += "\nIsPaymentToHO: " + IsPaymentToHO;
                    body += "\nPaymentEntryID: " + PaymentEntryID;
                    body += "\nInvoiceDate: " + deuFields.DeuData.InvoiceDate;
                    body += "\nLicenseeId: " + deuFields.LicenseeId;
                    body += "\nDeuEntryId: " + deuFields.DeuData.DEUENtryID;
                }
                else
                {
                    ActionLogger.Logger.WriteLog("deuFields is null", true);
                    body += "DeuFields is null";
                }
                MailServerDetail.sendMailtodev(to, "Commissions Alert: Exception occurred in deu while posting an entry", body);
            }
            catch (Exception ex)
            {
                ActionLogger.Logger.WriteLog("SendmailIfExceptionInDeuEntryPosting -  exception sending mail :" + ex.Message, true);
            }
        }
        ...
        public static void EntryInPolicyOutGoingPayment(bool IsPaymentToHO, Guid PaymentEntryID, Guid PolicyId, DateTime? InvoiceDate, Guid LicenseeId)
        {
            try
            {
                ...
                {
                    ActionLogger.Logger.WriteLog("Policy custom schedule true: ", true);
                ...
                {
                    ActionLogger.Logger.WriteLog("Policy default schedule true: ", true);
                    PolicyPaymentEntriesPost _PolicyPaymentEntriesPost = PolicyPaymentEntriesPost.GetPolicyPaymentEntry(PaymentEntryID);
                        ...
                        if (_PolicySchedule == PolicySchedule.Basic)
                        {
                            ...
                            else
                            {
                                if (_outgoingSchedule.FirstOrDefault().ScheduleTypeId == (int)MasterBasicOutgoinSchedule.PercentageOfCommission)
                                {
                                    ...
                                    //        body += "\nInvoiceDate: " + InvoiceDate;
                                    //        body += "\nLicenseeId: " + LicenseeId;
                                    //        MailServerDetail.sendMail("deudev@acmeminds.com", "Commissions Alert: Outgoing payments mismatch incoming payment in web", body);
                                    //    }
                                    //}
                                    //catch (Exception ex)
                                    //{
            ...
            catch (Exception ex)
            {
                ...
                body += "\nInvoiceDate: " + InvoiceDate;
                body += "\nLicenseeId: " + LicenseeId;
                MailServerDetail.sendMailtodev("deudev@acmeminds.com", "Commissions Alert: Exception adding outgoing payments in web", body);
        ...
        public static Guid GetPolicyHouseOwner(Guid PolicyLicenID)
        {
            try
            {
                ActionLogger.Logger.WriteLog("GetPolicyHouseOwner request :" + PolicyLicenID.ToString(), true);
                using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
                {
            ...
            {
                ActionLogger.Logger.WriteLog("GetPolicyHouseOwner exception :" + ex.Message.ToString(), true);
                return Guid.Empty;
            }
        ...
        public static void HandlePMCVariance(List<PolicyPaymentEntriesPost> _PolicyPaymentEntriesFormissing, string PMC, DateTime FirstDate, DateTime LastDate, Guid PolicyID)
        {
            try
            {
                ...
                if (flagvarience)
                {
                    ...
                    {
                        ActionLogger.Logger.WriteLog("PolicyID: " + PolicyID + ", flagvarience true but issue already exists, no action", true);
                    }
                    else //raise issue as not existing
                    {
                        ActionLogger.Logger.WriteLog("PolicyID: " + PolicyID + ", flagvarience true, adding issue", true);
                        ...
                        ActionLogger.Logger.WriteLog("PolicyID: " + PolicyID + ", PMC issue raised", true);
                    }
                }
                else
                {
                    ActionLogger.Logger.WriteLog("PolicyID: " + PolicyID + ", flagvarience false, removing issue", true);
            ...
            {
                ActionLogger.Logger.WriteLog("HandlePMCVariance exception for PolicyID: " + PolicyID + ", ex: " + ex.Message, true);
            }
        ...
        public static bool CheckForIncomingScheduleVariance(PolicyPaymentEntriesPost _TempPolicyPaymentEntriesPost, decimal? Premium)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("CheckForIncomingScheduleVariance :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("CheckForIncomingScheduleVariance :" + ex.InnerException.ToString(), true);
            }
            return Flag;
        }
        //public static bool CheckForIncomingScheduleVariance(PolicyPaymentEntriesPost _TempPolicyPaymentEntriesPost, decimal? Premium)
        ...
        public static bool CheckForOutgoingScheduleVariance(Guid PaymentEntryId, Guid ActivePolicyId)
        {
            ...
            {
                ActionLogger.Logger.WriteLog("CheckForOutgoingScheduleVariance :" + ex.StackTrace.ToString(), true);
                ActionLogger.Logger.WriteLog("CheckForOutgoingScheduleVariance :" + ex.Message, true);
            }
            return Flag;
        }
        ...
        // ---------------------------------------------------------Method Used for adding Incoming Payment ----------------------------------------
        ...
        {
            ActionLogger.Logger.WriteLog("Commission dahboard post - GetDeuCollection", true);
            ActionLogger.Logger.WriteLog("Commission dahboard post - New invoice date: " + PolicySelectedIncomingPaymentCommissionDashBoard.InvoiceDate, true);
        ...
        {
            ActionLogger.Logger.WriteLog("FillDEUFields:process begins for deufields DeuEntryId: " + DeuEntryId, true);
            DEUFields deufields = new DEUFields();
            try
            {
                DEU _DEU = DEU.GetDeuEntryidWise(DeuEntryId);
        ...
        public static void SaveInvoiceChangeLog(Guid RepostNewDeuEntryId, Guid UserId, Guid PolicyID)
        {
            try
            {
                ActionLogger.Logger.WriteLog("Saving invoice change log ", true);
            ...
            {
                ActionLogger.Logger.WriteLog("error saving invoice change log: " + e.Message, true);
            }
