...
namespace MyAgencyVault.BusinessLibrary
{
    ...
    public partial class PolicyDetailPreviousData
    {
        ...
        DateTime? _autoTerm;
        [DataMember]
        public DateTime? PolicyTermdateDate
        {
            get
            {
                return _autoTerm;
        ...
        public string AutoTerminationDateString
        {
            ...
            set
            {
                ...
                if (PolicyTermdateDate == null && !string.IsNullOrEmpty(autoTerminationdateString))
                {
                    DateTime dt;
                    DateTime.TryParse(autoTerminationdateString, out dt);
                    PolicyTermdateDate = dt;
                }
            }
        }
    ...
    public partial class PolicyDetailsData
    {
        ...
        [DataMember]
        public string ModalAvgPremium { get; set; }
        [DataMember]
        ...
        [DataMember]
        public Guid? SegmentId { get; set; }//Recently Added
     ...
     //   public DateTime? CreatedOn { get; set; }
        ...
        [DataMember]
        public bool? IsCreatedFromWeb { get; set; }
        [DataMember]
        public bool? IsLastModifiedFromWeb { get; set; }
        [DataMember]
    ...
    [DataContract]
    public partial class PolicyScheduleDetails
    {
        [DataMember]
    ...
    [DataContract]
    public class LinkPendingPolicy
    {
        [DataMember]
        public string PolicyNumber { get; set; }
        [DataMember]
