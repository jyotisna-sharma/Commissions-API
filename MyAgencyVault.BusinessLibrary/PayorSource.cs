...
namespace MyAgencyVault.BusinessLibrary
{
    ...
    public class PayorSource
    {
        ...
        public static PayorSource GetPayorSource(Guid PayorID, Guid LicenseeID )
        {
            PayorSource payorsource = null;
            try
            {
                using (DLinq.CommissionDepartmentEntities DataModel = Entity.DataModel)
                {
            ...
            {
                ActionLogger.Logger.WriteLog("GetPayorSource ex; " + ex.Message, true);
                throw ex;
            }
            return payorsource;
        }
