    ...
    public class DisplayBrokerCode
    {
        ...
        public DateTime? dtCreatedDate
        {
            ...
            set
            {
                ...
                if (value != null && string.IsNullOrEmpty(dtCreatedDatestring))
                {
                    dtCreatedDatestring = value.ToString();
                }
            }
        }
        string _dtCreatedDateString;
        [DataMember]
        public string dtCreatedDatestring
        {
            get
            {
                return _dtCreatedDateString;
            }
            set
            {
                _dtCreatedDateString = value;
                if ((dtCreatedDate == null || dtCreatedDate == DateTime.MinValue) && !string.IsNullOrEmpty(_dtCreatedDateString))
                {
                    DateTime dt;
                    DateTime.TryParse(_dtCreatedDateString, out dt);
                    dtCreatedDate = dt;
                }
            }
        }
        ...
        public DateTime? dtModifiedDate
        {
            ...
            set
            {
                ...
                if (value != null && string.IsNullOrEmpty(dtModifiedDatestring))
                {
                    dtModifiedDatestring = value.ToString();
                }
            }
        }
        string _dtModifiedDateString;
        [DataMember]
        public string dtModifiedDatestring
        {
            get
            {
                return _dtModifiedDateString;
            }
            set
            {
                _dtModifiedDateString = value;
                if ((dtModifiedDate == null || dtModifiedDate == DateTime.MinValue) && !string.IsNullOrEmpty(_dtModifiedDateString))
                {
                    DateTime dt;
                    DateTime.TryParse(_dtModifiedDateString, out dt);
                    dtModifiedDate = dt;
                }
            }
        }
