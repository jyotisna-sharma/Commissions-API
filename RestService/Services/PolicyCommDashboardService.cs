...
namespace MyAgencyVault.WcfService
{
    ...
    interface IPolicyCommDashboardService
    {
        ...
        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        JSONResponse AddUpdateOutgoingPaymentService(List<PolicyOutgoingDistribution> _PolicyOutgoingDistribution);

        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        JSONResponse ReverseOutgoingPaymentService(PolicyOutgoingDistribution OldPolicyOutgoingDistribution, PolicyOutgoingDistribution NewPolicyOutgoingDistribution);
    ...
    public partial class MavService : IPolicyCommDashboardService
    {
        ...
        /// Purpose:update the details of outgoing payments
        /// </summary>
        /// <param name="_PolicyOutgoingDistribution"></param>
        /// <returns></returns>
        public JSONResponse AddUpdateOutgoingPaymentService(List<PolicyOutgoingDistribution> _PolicyOutgoingDistribution)
        {
            JSONResponse jres = null;
        ...
        /// Purpose:Reverse Outgoing Payment for Commission dashboard
        /// </summary>
        /// <param name="OldPolicyOutgoingDistribution"></param>
        /// <param name="NewPolicyOutgoingDistribution"></param>
        /// <returns></returns>
        public JSONResponse ReverseOutgoingPaymentService(PolicyOutgoingDistribution OldPolicyOutgoingDistribution, PolicyOutgoingDistribution NewPolicyOutgoingDistribution)
        {
            JSONResponse jres = null;
            try
            {
                PolicyOutgoingDistribution.AddUpdateOutgoingPaymentEntry(OldPolicyOutgoingDistribution);
                PolicyOutgoingDistribution.AddUpdateOutgoingPaymentEntry(NewPolicyOutgoingDistribution);
                jres = new JSONResponse(string.Format("Data saved successfully"), Convert.ToInt16(ResponseCodes.Success), "");
                ActionLogger.Logger.WriteLog("AddUpdateOutgoingPaymentService success ", true);
            }
            catch (Exception ex)
        ...
        /// Modified on:12-04-2018
        /// Purpose:Used for Delete a Outgoing Payments
        /// </summary>
        /// <param name="outgoingPaymentId"></param>
        /// <returns></returns>
