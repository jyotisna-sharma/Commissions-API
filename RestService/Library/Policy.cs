...
namespace MyAgencyVault.WcfService
{
    ...
    interface IPolicy
    {
        ...
        //[OperationContract]
        //[WebInvoke(UriTemplate = "AddUpdatePolicyService", Method = "POST", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        //JSONResponse AddUpdatePolicyService(PolicyDetailsData policy);

        [OperationContract]
        PolicySavedStatus SavePolicyData(PolicyDetailsData Policy, PolicyDetailsData ReplacedPolicy);

        [OperationContract]
        PolicySavedStatus SavePolicy(PolicyDetailsData Policy, PolicyDetailsData ReplacedPolicy, string strRenewal,string strCoverageNickName, PolicyScheduleDetails policyScheduleDetails);
    ...
    public partial class MavService : IPolicy
    {
        ...
        //public JSONResponse AddUpdatePolicyService(PolicyDetailsData policy)
        //{
        ...
        //    catch (Exception ex)
        //    {
        //        jres = new JSONResponse(string.Format("Error saving policy: {0}", ex.Message), Convert.ToInt16(ResponseCodes.Failure), "");
        //    }
        //    return jres;
        //}
        ...
        public PolicySavedStatus SavePolicy(PolicyDetailsData PolicySave, PolicyDetailsData ReplacedPolicy, string strRenewal,string strCoverageNickName, PolicyScheduleDetails policyScheduleDetails)
        {
            return Policy.SavePolicy(PolicySave, ReplacedPolicy, strRenewal, strCoverageNickName,policyScheduleDetails);
        }
