...
namespace MyAgencyVault.WcfService
{
    ...
    interface IPostUtil
    {
        ...
        [OperationContract]
        PostProcessReturnStatus CommissionDashBoardPostStart(Guid BatchId, PolicyPaymentEntriesPost PaymentEntry, PostEntryProcess _PostEntryProcess, UserRole _UserRole);
    ...
    public partial class MavService : IPostUtil
    {
        ...
        {
            return DeuPostProcessWrapper.DeuPostStartWrapper_Old(_PostEntryProcess, deuFields, deuEntryId, userId, userRole);
        }
        ...
        public PostProcessReturnStatus CommissionDashBoardPostStart(Guid BatchId, PolicyPaymentEntriesPost PaymentEntry, PostEntryProcess _PostEntryProcess, UserRole _UserRole)
        {
            return CommissionDashboard.CommissionDashBoardPostStart(BatchId, PaymentEntry, _PostEntryProcess, _UserRole);
        }
