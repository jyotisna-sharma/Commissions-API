...
namespace MyAgencyVault.WcfService
{
    ...
    interface IBatch
    {
        ...
        //[OperationContract]
        //List<Batch> GetCurrentBatch(Guid licenceID, int CreatedOn);
    ...
    public partial class MavService : IBatch, IDownloadBatch
    {
        ...
        //public List<Batch> GetCurrentBatch(Guid licenceID, int CreatedOn)
        //{
        //    Batch objBatch = new Batch();
        ...
        //    return DEU.GetStatementCheckAmount(BatchID, PayorID);
        //}
